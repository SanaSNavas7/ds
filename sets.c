...
scanf("%d", &choice);
switch (choice) {
case 1: resultSize = setUnion(set1, size1, set2, size2, result);
displaySet(result, resultSize);
break;
case 2: resultSize = setIntersection(set1, size1, set2, size2, result);
displaySet(result, resultSize);
break;
case 3: resultSize = setDifference(set1, size1, set2, size2, result);
displaySet(result, resultSize);
break;
case 4: printf("\nSets:\n");
printf("Set 1: ");
